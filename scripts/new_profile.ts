...
const profileNameRegex = /^[a-z][a-z0-9_]{1,49}$/;
...
const addProfile = (profile: string) => {
  if (!profile.match(profileNameRegex)) throw new Error(`Profile name should be lowercased string matching ${profileNameRegex}`)
